...
class OutputCache
{
     ...
     * @var array
     */
    public $uncached_headers = ['transfer-encoding'];
     ...
     */
    protected function do_headers($headers1, $headers2 = [])
    {
...
HTML;
    ...
    protected function start()
    {
        ...
        // Headers and such
        add_filter('status_header', [$this, 'status_header'], 10, 2);
        add_filter('wp_redirect_status', [$this, 'redirect_status'], 10, 2);
    ...
    private function maybe_do_redirect()
    {
        ...
        if ($this->cache['redirect_status'] && $this->cache['redirect_location'] && $this->cache_redirects) {
            ...
            // From vars.php
            $is_IIS = (false !== strpos($_SERVER['SERVER_SOFTWARE'], 'Microsoft-IIS') || false !== strpos($_SERVER['SERVER_SOFTWARE'], 'ExpressionDevServer'));
    ...
    private function has_cookies()
    {
        ...
        foreach ($cookie_keys as $cookie_key) {
            ...
            if ('comment_author' === substr($cookie_key, 0, 14)) {
                return true;
            }

            // Generic 'wordpress' cookies (that are not test cookies)
            if (('wordpress' === substr($cookie_key, 0, 9)) && ('wordpress_test_cookie' !== $cookie_key)) {
                return true;
            }
        }
